...
if __name__=="__main__":
    ...
    cfg.TRAIN.DATA.DIR = '/snel/home/lwimala/tmp/cs7643_project/run_000/lfads_input/'
    cfg.TRAIN.DATA.PREFIX = 'lfads'
    cfg.TRAIN.MODEL_DIR = '/snel/home/lwimala/tmp/cs7643_project/run_000/lfads_output/'
    ...
    cfg.MODEL.GEN_DIM = 10 
    cfg.MODEL.IC_ENC_DIM = 64 
    cfg.MODEL.CI_ENC_DIM = 64 
    cfg.MODEL.CON_DIM = 64 
    cfg.MODEL.SEQ_LEN = 100
    cfg.MODEL.IC_DIM = 10
    cfg.MODEL.CO_DIM = 1
    cfg.MODEL.FAC_DIM = 5
    cfg.TRAIN.KL.IC_WEIGHT = 1e-5
    cfg.TRAIN.KL.CO_WEIGHT = 1e-3
    cfg.TRAIN.KL.INCREASE_EPOCH = 50
    cfg.TRAIN.L2.INCREASE_EPOCH = 50
    cfg.TRAIN.L2.GEN_SCALE = 1e-4
    cfg.TRAIN.L2.CON_SCALE = 1e1
    cfg.TRAIN.PATIENCE = 15 # number of epochs to wait before early stopping
    ...
    cfg.TRAIN.MAX_EPOCHS = 10000 # maximum number of training epochs
